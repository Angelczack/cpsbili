<template>
	<view class="wrap">
		<!-- goback -->
		<u-navbar back-text="返回" is-back="true" title="编辑地址" height="60" :background="background" back-icon-color="#fff" :back-text-style="backStyle" title-color="#fff"></u-navbar>
		<view class="top">
			<view class="item">
		...
		<!-- submit -->
		<button
			style="width: 35%; height: 80rpx; background-color:#fff; margin-top: 30rpx; border: none; color: #666; text-align: center; line-height: 80rpx; border-radius: 5px; font-size: 14px;"
			plain="true" @click="gobackadd">提交</button>
	</view>
</template>
