	...
	<view>
		<view class="top">
		  <view class="top-left">
		    ...
		    <view style="white-space: nowrap; margin-left: 20rpx; font-size: 28rpx; color: #999; font-weight: 600;">官方直营 • 正品保障</view>
		  </view>
		...
		<!-- 搜索 -->
		<view class="search">
		  <input type="text" style="width: 70%; height: 20rpx; border: 1rpx solid #ff9bb9; position: relative; padding-left: 80rpx; padding-top: 15rpx; padding-bottom: 15rpx; border-radius: 20rpx;" placeholder="魔力奖励限时进阶" placeholder-style="font-szie:15px;" />
		  <icon type="search" color="#ff9bb9" style="position: absolute; left: 40rpx; top:125rpx; width: 100%; height: 100%;" />
		
		  <view>
		    <text decode="true" style="text-align: center; display: flex; justify-content: center; font-weight: 600; font-style: italic;">ALL\n</text>
		    <text decode="true" style="font-size: 25rpx; display: flex; justify-content: center; font-weight: 900;">分类</text>
		  </view>
		...
		<view class="con">
		  <view class="con-left">
		    <swiper style="width: 100%; height: 270rpx; border-radius: 30rpx; overflow: hidden;" indicator-dots="true" indicator-color="#666" indicator-active-color="#fff" autoplay interval="2000" circular>
		      <block v-for="(item,index) in conUrl" :key="index">
		        <swiper-item style="width: 100%; height: 270rpx; border-radius: 40rpx; overflow: hidden;">
		          <image :src="item" mode="aspectFit" style="width: 100%; height: 100%; border-radius: 40rpx; overflow: hidden;" />
		        </swiper-item>
		      </block>
		    </swiper>
		  </view>
		  ...
		  <view class="con-right">
		    <image src="/static/shop/conimg/con-right.png" style="width:100%; height:92%; border-radius: 20rpx; overflow: hidden; margin-top: 11rpx;" />
...
<style scoped>
	...
	/* 全局样式 */
	page{background-color:rgb(240,242,242)}
	.top {
	  width: 100%;
	  height: 100rpx;
	...
	.shops-left-word{font-size: 30rpx; width: 300rpx; height: 80rpx; margin: -20rpx auto;}
	...
	.shops-right-word{font-size: 30rpx; width: 300rpx; height: 80rpx; margin: -20rpx auto;}
