<template>
	<view>
		<!-- goback -->
		<u-navbar back-text="返回" is-back="true" title="管理地址" height="60" :background="background" back-icon-color="#fff" :back-text-style="backStyle" title-color="#fff"></u-navbar>
