...
<template>
	<view>
		...
		<!-- swiper -->
		   <swiper style="width: 95%; height: 400rpx; margin: 20px auto; border-radius: 5px; overflow: hidden;" :indicator-dots="true" indicator-color="#666" indicator-active-color="#fff" :autoplay="true" :interval="2000" circular="true">
		      <block v-for="(item,index) in imgUrl" :key="index-1">
		        <swiper-item>
